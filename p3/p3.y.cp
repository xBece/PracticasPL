...
expresion                   : PAR_IZQ expresion_par
                            | expresion_op_unario
                            | MENOS expresion_menos_unario
                            | expresion_binario
                            | expresion_menos_binario
                            | IDENTIFICADOR
                            | constante
                            | acceso_lista
                            | error
                            ;
expresion_par               : expresion PAR_DER
                            | error PYC
                            ;
expresion_op_unario         : OP_UNARIO expresion
                            ;
expresion_menos_unario      : expresion
                            ;
expresion_binario           : expresion OP_BINARIO expresion
                            ;
expresion_menos_binario     : expresion MENOS expresion
                            ;
